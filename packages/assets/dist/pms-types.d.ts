...
export declare const MAX_SECTOR = 25;
/** PORT: PolyMap.pas — maximum props and scenery. */
export declare const MAX_PROPS = 500;
/** PORT: PolyMap.pas — maximum circular colliders. */
export declare const MAX_COLLIDERS = 128;
/** PORT: PolyMap.pas — maximum spawnpoints. */
export declare const MAX_SPAWNPOINTS = 255;
...
//# sourceMappingURL=pms-types.d.ts.map