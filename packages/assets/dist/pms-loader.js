...
import { MAX_COLLIDERS, MAX_CONNECTIONS, MAX_POLYS, MAX_PROPS, MAX_SECTOR, MAX_SPAWNPOINTS, MAX_WAYPOINTS, } from './pms-types';
 ...
 */
export function loadPms(buffer) {
    ...
    for (let i = 0; i < n; i++) {
        ...
        const polyType = bf.readUint8();
        polygons.push({
            vertices: [v1, v2, v3],
            normals: [nrm1, nrm2, nrm3],
            polyType,
...
//# sourceMappingURL=pms-loader.js.map