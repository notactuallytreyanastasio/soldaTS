...
import { captureSpriteSnapshot, captureSpriteSnapshotOne, applySpriteSnapshot, diffSpriteSnapshot, applySpriteDelta, } from "./snapshot";
 ...
 * unambiguous.
 */
function spawnSprite(world, num, pos, vel, health) {
