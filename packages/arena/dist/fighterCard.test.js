...
describe('validateCard', () => {
    ...
    it('rejects wrong schema, missing coach, unknown engine, bad knobs', () => {
        ...
        expect(() => validateCard({ ...good, tweaks: { NOT_A_KNOB: 1 } })).toThrow(/unknown knob/);
        expect(() => validateCard({ ...good, tweaks: { RANGE_MAX: NaN } })).toThrow(/finite/);
    });
...
//# sourceMappingURL=fighterCard.test.js.map