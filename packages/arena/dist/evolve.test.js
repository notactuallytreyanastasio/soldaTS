...
import { NEURAL_SHIPPED_NET, NeuralPolicy, createNeuralEngineWithWeights, } from '@soldat/client/headless';
import { CHECKPOINT_SCHEMA, esUpdate, flattenNet, makeCheckpoint, mulberry32, paramCount, parseCheckpoint, rankShape, registerNeuralNet, rms, samplePerturbations, unflattenNet, } from './evolve';
...
describe('weight injection reaches the brain', () => {
    ...
    function withBumpedFireBias(delta) {
