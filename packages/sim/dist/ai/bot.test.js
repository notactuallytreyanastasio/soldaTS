...
import { updateBot, createBotState, checkDistance, simpleDecision, DIST_TOO_CLOSE, DIST_VERY_CLOSE, DIST_FAR, } from './bot';
/**
 ...
 */
function makeWorld(posA, posB, velB = { x: 0, y: 0 }) {
