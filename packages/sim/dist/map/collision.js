 ...
 */
export const SPRITE_COLLISION_POINTS = Object.freeze([
 ...
 */
export function flatGroundCollision(posY, velY, floorY) {
 ...
 */
export function segmentCircleCollision(segStart, segEnd, center, radius) {
