...
// PORT: shared/Parts.pas:35-39 — Constraint record.
export interface Constraint {
  active: boolean;
  partA: number; // 1-indexed particle id
  partB: number; // 1-indexed particle id
  restlength: number;
}
...
export class ParticleSystem {
  ...
  readonly active: boolean[] = new Array<boolean>(NUM_PARTICLES + 1).fill(false);
  readonly posX = new Float32Array(NUM_PARTICLES + 1);
  readonly posY = new Float32Array(NUM_PARTICLES + 1);
  readonly velocityX = new Float32Array(NUM_PARTICLES + 1);
  readonly velocityY = new Float32Array(NUM_PARTICLES + 1);
  readonly oldX = new Float32Array(NUM_PARTICLES + 1);
  readonly oldY = new Float32Array(NUM_PARTICLES + 1);
  readonly forceX = new Float32Array(NUM_PARTICLES + 1);
  readonly forceY = new Float32Array(NUM_PARTICLES + 1);
  readonly oneOverMass = new Float32Array(NUM_PARTICLES + 1);
