...
> The story of how all this got built is the blog: [README.md](README.md).
...
| `packages/protocol` / `netcode` / `assets` / `modding` | Wire schema + codec, replication/prediction, `.PMS` map loading, sandboxed mod host (see `PROCESS.md`). |
